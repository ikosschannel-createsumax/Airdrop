...
export default function GameCanvas({
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      ctx.textAlign = "right";
      ctx.fillText("WARN: LIMIT BAHAYA MINE CRASH", WIDTH - 12, DANGER_LINE_Y - 6);
    ...
    <div className="flex flex-col lg:flex-row gap-6 items-start justify-center max-w-5xl mx-auto py-2">
      ...
      <div className="flex flex-col items-center select-none bg-[#111420] border-2 border-gray-800 rounded-2xl shadow-xl p-4 w-full max-w-[420px] mx-auto shrink-0 relative overflow-hidden">
        ...
        <div className="w-full flex justify-between items-center mb-3">
          <div>
            <span className="text-[10px] font-mono tracking-widest text-gray-500 block">SCORE SELESTIAL</span>
          ...
          <div className="h-10 flex items-center text-right">
            {comboCount > 0 && (
              <div className="bg-amber-500/10 border border-amber-500/30 px-2 py-1 rounded text-xs font-mono text-amber-400 font-bold animate-bounce leading-none">
                {comboText || `Kombinasi x${comboCount}`}
              </div>
            )}
          </div>

          <div className="text-right">
            <span className="text-[10px] font-mono tracking-widest text-gray-500 block uppercase">REKOR ANDA</span>
        ...
        <div className="w-full bg-[#161a29] border border-gray-850 p-2.5 rounded-xl flex items-center justify-between mb-3.5">
          <div className="flex items-center gap-2">
            ...
            <div className="leading-tight">
              <span className="text-[9px] font-mono text-gray-500 block">SIAP DIJATUHKAN</span>
          ...
          <div className="bg-gray-900/80 border border-gray-700 p-1.5 px-3 rounded-lg flex items-center gap-2">
            <span className="text-[9px] font-mono uppercase tracking-widest text-amber-500 font-bold">LANJUT:</span>
        ...
        >
          ...
          {showDangerWarning && (
            <div className="absolute top-28 inset-x-0 mx-auto max-w-[280px] bg-red-950/90 border border-red-500 text-red-200 px-3 py-2 rounded-lg text-center animate-pulse z-30 shadow-lg font-mono">
              <p className="text-xs font-bold uppercase tracking-widest">⚠️ RADAR BAHAYA PENUH ⚠️</p>
              <p className="text-[10px] text-red-400 mt-0.5 leading-tight">
                Kosongkan puncak tambang dalam {dangerTimer} detik sebelum keruntuhan sektor!
              </p>
            </div>
          )}
          ...
          {objectsRef.current.length === 0 && !isGameOverState && (
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none p-6 text-center bg-transparent z-10">
              ...
              <p className="text-sm font-bold text-gray-200">Sentuh Layar Untuk Menjatuhkan</p>
              <p className="text-xs text-gray-500 mt-1 max-w-[240px]">
                Geser jari atau kursor Anda ke samping lalu lepas untuk menjatuhkan mineral ke corong reaktor.
              </p>
            </div>
          )}
          ...
          {isGameOverState && (
            <div className="absolute inset-0 bg-black/92 flex flex-col items-center justify-center p-6 text-center z-40 transition-all font-sans">
              ...
              <h3 className="text-2xl font-black text-white tracking-tight uppercase">Sektor Runtuh!</h3>
              <p className="text-xs text-rose-500 font-mono mt-1">SEKTOR PERTAMBANGAN DIHENTIKAN</p>
              ...
              <div className="w-full bg-[#161a29] border border-gray-850 p-4 rounded-xl my-5 space-y-2 max-w-[260px] mx-auto text-left">
                <div className="flex justify-between items-center text-xs">
                  <span className="text-gray-400">Poin Merging:</span>
                  <span className="font-mono text-white font-bold">{currentScore} Pts</span>
                </div>
                <div className="flex justify-between items-center text-xs">
                  <span className="text-gray-400">Multiplier Rig:</span>
        ...
        <div className="w-full mt-4 grid grid-cols-2 gap-3">
          ...
          >
            <Bomb size={16} />
            <span>DINAMIT ({dynamiteCount})</span>
          </button>
      ...
      <div className="grow bg-[#141822] p-5 rounded-2xl border border-gray-800 w-full max-w-[500px] lg:max-w-none">
        <h3 className="text-sm font-mono uppercase tracking-wider text-amber-400 flex items-center gap-1.5 mb-3">
          <span>📚 INDEX EVOLUSI LOGAM (LDR FUSION):</span>
        </h3>
        <p className="text-xs text-gray-400 mb-4 leading-relaxed">
          Kombinasikan dua bijih mineral yang sejenis untuk memicunya melompat ke fase tingkat energi mineral di atasnya. Menggabungkan mineral yang bernilai tinggi menghasilkan poin skor raksasa dan bonus Koin LDR instan!
        </p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
          {ORE_DEFINITIONS.map((def) => {
            return (
              <div 
                key={def.level} 
                className="flex items-center gap-2.5 p-2 bg-[#181d2a] border border-gray-800 rounded-xl text-left"
              >
                ...
                <div className="overflow-hidden min-w-0">
                  ...
                  <span className="text-[10px] text-gray-500 block truncate leading-none mt-0.5">
                    {def.localName}
                  </span>
        ...
        <div className="bg-yellow-900/10 border border-yellow-700/20 p-3.5 rounded-xl mt-5">
          <h4 className="text-xs font-bold text-amber-400 uppercase tracking-wide flex items-center gap-1">
            <span>🔥 STRATEGI BERLIAN:</span>
          </h4>
          <p className="text-xs text-gray-400 mt-1.5 leading-snug">
            Gunakan <span className="text-amber-400 font-medium">Beliung Super</span> di Rig Tambang untuk mempercepat kelipatan multiplier koin yang didapatkan dari menjatuhkan ore secara manual! Atur juga keseimbangan antara bermain manual dan membeli rig otomatis agar pundi-pundi koin LDR mengalir secara optimal.
          </p>
        </div>
      </div>
